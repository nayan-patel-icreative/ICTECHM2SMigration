...
class AdvancedPriceMapper
{
     ...
     *
     * @param array<int, array<string, mixed>> $prices  Magento product prices array array
     * @param array<string, string> $variantIdByMagentoId  mageVariantId => shopifyVariantGid
