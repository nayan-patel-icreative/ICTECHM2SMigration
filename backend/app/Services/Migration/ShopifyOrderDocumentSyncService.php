 ...
 *   1. Download PDF from Magento (with Bearer token — required for /api/_action/document/)
...
class ShopifyOrderDocumentSyncService
{
     ...
     * @param string $magentoToken  Magento REST API access token for authenticated download
    ...
    /**
     * Download a document from Magento REST API.
